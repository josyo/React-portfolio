...
export default function Hero() {
   ...
   <div className="grid lg:grid-cols-[0.95fr_1.55fr] gap-12 lg:gap-20 items-stretch w-full">
      ...
      >
         ...
         {/* Tech Stack */}
         <div className="flex flex-wrap justify-center lg:justify-start gap-2 sm:gap-3 flex-nowrap overflow-x-auto">
            {["React", "Next.js", "NestJS", "TypeScript", "Tailwind"].map(
               (tech) => (
                  <span
                     key={tech}
                     className="px-3 py-1 text-[11px] sm:text-sm rounded-lg border border-white/10 bg-white/5 text-slate-300 whitespace-nowrap"
                  >
                     {tech}
                  </span>
               )
